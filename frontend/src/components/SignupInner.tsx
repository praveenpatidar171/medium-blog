        ...
        <div className="h-screen w-full flex items-center justify-center">
            <div className="w-96 rounded-lg border border-gray-200 shadow-2xl p-8">
                <div className="text-center">
                    ...
                    <h2 className="text-sm font-semibold text-gray-400">Already have an account? <Link className="underline" to={'/signin'}>Signin</Link></h2>
                </div>
                ...
                <button onClick={handleSubmit} className="p-2 w-full rounded-md text-bold bg-black text-white cursor-pointer">{loading ? <span className="flex justify-center items-center"><Loader2 className="h-4 w-4 animate-spin mr-2" /> Please wait..</span> : 'SignUp'}</button>
            </div>
        </div>
    )
}
